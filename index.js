...
client.on('messageCreate', async (message) => {
    ...
    if (message.content === '/setup') {
        ...
        try {
            ...
            message.reply('✅ Yeni panel kırmızı renk ve uyarı yazısı ile kuruldu!');
        } catch (e) { message.reply('⚠️ Hata oluştu.'); }
    }
});

// Etkileşim (Bilet açma/kapama) kısmı aynı kalacak...
